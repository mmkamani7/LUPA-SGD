"""Utilities for training used in the paper:
...
class SyncHook(tf.train.SessionRunHook):
  ...
  def __init__(self, scopes, every_n_steps=1000, every_n_secs=None, adaptive=None):
  ...
  def before_run(self, run_context):
    ...
    if self._timer.should_trigger_for_step(global_step):
      ...
      if self.adaptive is not None:
        self.count += 1
        self._timer._every_steps = self.adaptive[self.count]
